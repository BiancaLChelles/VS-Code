...
def tradutor_fisico(texto_usuario):
  ...
  "DISSOCIAÇÃO": [
   ...
   "ALIVIO": [
    "aliviado", "melhorando", "descansando", "recuperando", "alívio", "melhora", "descanso", "recuperação", 
    "aliviando", "melhorando aos poucos", "descansando um pouco", "recuperando aos aos poucos", "alívio gradual", 
    "melhora lenta", "descanso necessário", "corpo relaxando", "respiração voltando", "baixando a guarda", 
    "peso saindo", "conseguindo respirar", "alivio", "melhorand", "recuperand", "descansand", "aliviad", 
    "mto melhor", "bem melhor agr", "passando a dor", "corpo leve", "mente calma", "paz de espírito", 
    "conseguindo relaxar", "aliviadão", "melhor d+", "uufa", "suspiro", "descompressão", "aliviooo", 
    "tirar o peso das costas", "sensação de dever cumprido", "corpo em modo de segurança", "recarregando", 
    "voltar pro eixo", "pé no chão", "cérebro esfriando", "calmaria dps da tempestade", "tá passando", 
    "n dói tanto", "sentindo-se humano de novo", "aliv", "melhoro", "descans", "finalment", "ufa", 
    "saiu um piano das costas", "descarregando", "resetando", "voltei a orbita", "corpo esfriando", 
    "batimento acalmando", "nó desfazendo", "sensacao de frescor", "brisa vindo", "alivio total", 
    "melhorada", "melhorade", "aliviada", "aliviade", "recuperada", "recuperade", "descansada", 
    "descansade", "soltando o ar", "ombros descendo", "musculos soltando", "corpo amolecendo", 
    "fim da crise", "pos meltdown", "pos shutdown", "estabilizando", "sistema ok", "voltei", 
    "to de volta", "conseguindo pensar", "clariou", "nuvem saindo", "sem pressao", "paz total", 
    "silencio interno", "pousando", "tirando a armadura", "desarmando", "aliviadissim", "mto b", 
    "corpo agradecendo", "reboot concluido", "sensacao de casa", "seguranca"
],
   ...
   "NOJO": [
    ...
    "ALEGRIA": [
    "alegria", "feliz", "felicidade", "contente", "alegre", "animado", "animada", "animade", 
    "empolgado", "empolgada", "empolgade", "radiante", "eufórico", "eufórica", "eufórice", 
    "dopamina", "dopaminado", "dopaminada", "dopaminade", "sorrindo", "rindo", "saltitante", 
    "vibração boa", "energia alta", "entusiasmado", "entusiasmada", "entusiasmade", "maravilhoso", 
    "maravilhosa", "perfeito", "tá tudo bem", "dia bom", "notícia boa", "venci", "consegui", 
    "alegri", "felis", "feliiz", "felicidada", "contente dms", "animadissim", "empolgadão", 
    "empolgadona", "dopaminadaa", "uhul", "eba", "aeeee", "viva", "que bom", "fico feliz", 
    "muito feliz", "mto feliz", "feliz d+", "feliz dms", "alegria total", "coração quentinho", 
    "alma lavada", "querendo pular", "vontade de dançar", "stimming de alegria", "flapping", 
    "balançando as mãos", "gritinho de felicidade", "sorrisão", "olho brilhando", "leveza", 
    "paz e alegria", "radiante dms", "nas nuvens", "flutuando", "zerando a vida", "extase", 
    "maravi", "perfeit", "top", "mto bom", "bom dms", "alegriaa", "felicidd", "empolg", 
    "animad", "alegre d+", "brilhando", "explodindo de alegria", "corpo vibrando", 
    "sensação de vitória", "me sinto bem", "to bem", "tô bem", "tudo dando certo", 
    "finalmente feliz", "alegria contagiante", "rindo atoa", "rindo de tudo", 
    "estado de graça", "iluminada", "iluminade", "iluminado"
],
    "LUTO": [
    "luto", "perda", "tristeza profunda", "choro", "sofrimento", "processando a perda", "saudade", 
    "vazio", "ausência", "partida", "adeus", "eterno", "memória", "lembrança", "dor da perda", 
    "coração partido", "alma pesada", "vazio no peito", "ausencia", "saudad", "lutooo", "perdaa", 
    "tristeza extrema", "sofrimento total", "n da pra acreditar", "parece mentira", "queria q fosse um pesadelo", 
    "pesadelo acordado", "sem chão", "sem norte", "perdi meu rumo", "luto eterno", "luto oficial", 
    "sentindo a falta", "falta dele", "falta dela", "falta delee", "falta delaa", "saudades dele", 
    "saudades dela", "saudades eternas", "dói muito", "doi dms", "n aguento essa dor", "triste dms", "sinto falta",
    "tristeza sem fim", "melancolia profunda", "luto constante", "vivendo o luto", "fases do luto", 
    "negação", "raiva de luto", "depressão de luto", "aceitação", "doloroso", "angustiante", 
    "sozinho no mundo", "solidao de luto", "silencio que machuca", "silencio ensurdecedor", 
    "n quero falar sobre", "preciso de tempo", "me deixa no meu canto", "respeita meu luto", 
    "luto dms", "perdi alguem", "foi pro ceu", "virou estrela", "virou anjinho", "descanse em paz", 
    "rip", "dep", "em memoria", "saudade q n cabe", "vazio imenso", "peito apertado", "choro preso", 
    "desolado", "desolada", "desolade", "arrasado", "arrasada", "arrasade", "destruido", "destruida", 
    "destruide", "em frangalhos", "coração em pedaços", "saudadesss", "luto mto", "perda total", 
    "vazio que não preenche", "sentir falta", "querendo ver de novo", "querendo ouvir a voz", 
    "fazendo falta", "faz falta", "faz mta falta", "doi mto", "doiii"
],
